        ...
        <div id="qodef-page-header-inner">
            ...
            <nav class="qodef-header-navigation" role="navigation" aria-label="Top Menu">
                <ul id="menu-main-menu-1" class="menu">
                    ...
                    <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-11 qodef-menu-item--narrow"><a href="#"><span class="qodef-menu-item-text">CATEGORY</span></a>
                        <div class="qodef-drop-down-second">
                            <div class="qodef-drop-down-second-inner">
                                <ul class="sub-menu">
                                    <?php foreach ($category as $categorys):?>
                                    <li class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item current_page_item menu-item-327"><a href="<?=\yii\helpers\Url::to(["/site/index?id=$categorys->id"], true)?>"><span class="qodef-menu-item-text"><?php echo $categorys->category_name; ?></span></a></li>
                                    <?php endforeach;?>
                                </ul>
                            </div>
                        </div>
